...
| # | Term | Answer |
|---|------|--------|
| 1 | Normal Equation | (f) Precisely calculating a set of parameters that minimizes error |
| 2 | Randomized Search | (i) Finding highly-effective combinations of hyperparameters |
| 3 | Scatterplot Matrix | (l) Gaining insights during data exploration |
| 4 | Stratified Sampling | (g) Making sure the test set has a representative distribution |
| 5 | F1-Score | (h) Numerically evaluating a classification model |
| 6 | Confusion Matrix | (j) Identifying which classes a classifier is struggling with |
| 7 | Regularization | (c) Simplifying a model to reduce the likelihood of overfitting |
| 8 | RMSE | (d) Numerically evaluating a regression model |
| 9 | Learning Rate | (e) Impacts the amount of parameter changes in each iteration |
| 10 | Cross-Validation | (b) Evaluating a model and detecting overfitting |
| 11 | Gradient Descent | (a) Iteratively finding a set of parameters that minimizes error |
| 12 | Pipeline | (k) Streamlines code by merging preprocessing and model fitting |
...
**Q1. (Security classifier — precision vs. recall) Which metric would you prioritize and why?**
...
**Q2. (Large dataset — Normal Equation vs. Gradient Descent) What are the tradeoffs?**
...
**Q3. Why can accuracy be a misleading metric for some classification problems?**
...
**Q4. Compare and contrast One-versus-One and One-versus-All classifiers.**
...
**Q5. Compute the model output given the weights and inputs.**
...
**Q6. Give a high-level description of how gradient descent works.**
...
**Q7. Should you use ordinal encoding or one-hot encoding for a t-shirt size feature (S, M, L, XL)? Why?**
...
**Q8. How do total epochs and learning rate each affect model training?**
...
**Q9. Given a small dataset, how would you split the data and evaluate the model during training?**
