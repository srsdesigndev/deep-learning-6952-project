...
| 2 | Normal Equation | (h) Precisely calculating a set of parameters that minimizes error |
| 3 | Learning Rate | (e) Impacts the amount of parameter changes in each iteration |
| 4 | Regularization | (f) Simplifying a model to reduce the likelihood of overfitting |
| 5 | Cross-Validation | (c) Evaluating a model and detecting overfitting |
| 6 | Randomized Search | (a) Finding highly-effective combinations of hyperparameters |
| 7 | Pipeline | (d) Streamlines code by merging preprocessing and model fitting |
| 8 | Scatterplot Matrix | (i) Gaining insights during data exploration |
| 9 | RMSE | (l) Numerically evaluating a regression model |
| 10 | F1-Score | (j) Numerically evaluating a classification model |
| 11 | Stratified Sampling | (b) Making sure the test set has a representative distribution |
| 12 | Gradient Descent | (k) Iteratively finding a set of parameters that minimizes error |
...
**Q2. Given a small dataset, how would you split the data and evaluate the model during training?**
...
**Q3. (Large dataset — Normal Equation vs. Gradient Descent) What are the tradeoffs?**
...
**Q4. Compute the model output given the weights and inputs.**
...
**Q5. Give a high-level description of how gradient descent works.**
...
**Q7. How do total epochs and learning rate each affect model training?**
...
**Q8. (Security classifier — precision vs. recall) Which metric would you prioritize and why?**
...
**Q9. Should you use ordinal encoding or one-hot encoding for a t-shirt size feature (S, M, L, XL)? Why?**
