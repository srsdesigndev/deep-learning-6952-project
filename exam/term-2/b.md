...
| # | Term | Answer |
|---|------|--------|
| 1 | Dense Layer | (d) Hidden or Fully-Connected |
| 2 | Learning Curve | (f) Line Chart |
| 3 | Variance | (a) Tendency to Overfit |
| 4 | Binary Cross-Entropy | (k) Log Loss |
| 5 | Softmax | (c) 0.08 0.03 0.02 0.87 |
| 6 | Forward Pass | (b) model(X_batch) |
| 7 | sgn(z) | (e) Perceptrons |
| 8 | Regularization | (g) LASSO Regression |
| 9 | Backward Pass | (j) Gradient Calculation |
| 10 | Sigmoid | (l) Logistic Function |
| 11 | Bias | (h) Model Simplicity/Assumptions |
| 12 | Tanh | (i) Zero-Centered |

---

## Section 2: Multiple Choice (4pts each, 10 best = 40pts)

**Q1. Suppose you have a neural network model with the following attributes:**
- 2 inputs
...
**Q2. Which of the following visualizations depicts the XOR operator?**
...
**Q3. Your sklearn neural network has the following `verbose=True` printout. Which of the following would be the best assessment of the model's training?**
...
**Q5. Which of the following statements about Ridge regression is true?**
...
**Q7. What occurs when `optimizer.step()` is called during model training in PyTorch?**
...
**Q9. Which of the following is known to help reduce overfitting?**
...
**Q10. Suppose you have a neural network with two hidden layers, each with 15 neurons. How many total biases will the hidden layers have?**
...
**Q11. What term would be most commonly used to describe a neural network with 50 hidden layers?**
...
**Q1. Compare and contrast using Scikit-Learn and PyTorch for working with neural network models. Give one advantage and one disadvantage for each option.**
...
**Q2. Give a high-level overview of backpropagation for neural networks.**
...
**Q3. Why do ML folks often seek out differentiable mathematical functions for use in their models?**
...
**Q4. Give a high-level description of how we can use learning curves to assess model fit.**
...
**Q6. Data scientists often observe that using ReLU activation function, ReLU(x) = max(0, x), can improve model training speed. Give two different reasons why this might be the case.**
...
**Q7. Suppose that we have a feed-forward neural network model with n hidden layers, each with 100 neurons. How many biases will the model have, in terms of n?**
...
**Q8. Consider the following custom network in PyTorch. In one sentence, briefly summarize how data flows through the `forward()` function.**
...
**Q9. Consider the cost function for Ridge regression below. What is the purpose of the parameter α?**
